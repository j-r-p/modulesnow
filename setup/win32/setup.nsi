...
!define MUI_FINISHPAGE_LINK_LOCATION "https://www.modulesnow.com/page/contactus"
...
Section -Post
    ...
    WriteRegStr HKLM       "${UNINSTALL_REGISTRY_KEY}" "URLInfoAbout" "https://www.modulesnow.com"
