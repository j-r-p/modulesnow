...
function documentationItem(env) {
    const documentationURL = "https://www.modulesnow.com/documentation/17.0";
    return {
        type: "item",
        id: "documentation",
...
function odooAccountItem(env) {
    return {
        type: "item",
        id: "account",
        description: _t("My Modulesnow.com account"),
        callback: () => {
            env.services
                ...
                .catch(() => {
                    browser.open("https://accounts.modulesnow.com/account", "_blank");
                });
        },
        sequence: 60,
    };
